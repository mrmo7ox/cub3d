...
#    Updated: 2025/07/28 13:51:58 by moel-oua         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ESEC = exec/alpha.c exec/utils.c exec/player.c exec/minimap.c exec/draw_urtils.c exec/img_utils.c exec/hooks.c exec/run.c 
